...
**Note**: Always take caution when updating; don’t forget to**first test on a staging site** as instructed above in [Testing updates](https://woocommerce.com/document/updating-woocommerce/#testing-updates).
