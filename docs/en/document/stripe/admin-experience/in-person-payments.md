...
- **Cash**
- Card reader
  - You’ll also be given the option to use [Tap to Pay](https://woocommerce.com/document/stripe/admin-experience/in-person-payments/#collecting-payment-ttp) to collect the payment if you are using a supported device.
...
1. [Build orders](https://woocommerce.com/document/stripe/admin-experience/in-person-payments/#build-orders)
2. [Collect payments for an order placed online](https://woocommerce.com/document/stripe/admin-experience/in-person-payments/#collect-order-payment)
