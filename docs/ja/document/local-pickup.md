---
title: 現地ピックアップ
url: https://woocommerce.com/document/local-pickup/
---
...
- デフォルトでは、ローカルピックアップを選択すると、顧客の住所に関係なく、店舗の住所を使用して税金が計算されます。

8. **（オプション）** このオプションの「価格」を入力します。これはカート全体に適用されます。

9. **作成** ボタンをクリックして終了します。

配送エリア内にお住まいの場合、お客様はカート/チェックアウト画面で「ローカルピックアップ」を選択できます。カートとチェックアウト画面に表示される内容は以下のとおりです。
