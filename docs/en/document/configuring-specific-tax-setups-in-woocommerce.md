...
url: https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/
---
...
1. [General settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-1-general-settings)
2. [Tax settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-1-tax-settings)
3. [Tax rates](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-1-tax-rates)
...
1. [General settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-2-general-settings)
2. [Tax settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-2-tax-settings)
3. [Tax rates](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-2-tax-rates)
...
1. [General settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-3-general-settings)
2. [Tax settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-3-tax-settings)
3. [Tax rates](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-3-tax-rates)
...
1. [General settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-5-general-settings)
2. [Tax settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-5-tax-settings)
3. [Tax rates](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-5-tax-rates)
4. [Product settings](https://woocommerce.com/document/configuring-specific-tax-setups-in-woocommerce/#scenario-5-product-settings)
