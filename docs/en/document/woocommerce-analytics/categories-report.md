...
The Categories Report provides insight into the product categories of your store.
...
Both links open the Single Category report listing the products sold within that category.
